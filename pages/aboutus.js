        ...
        <Body className="flex flex-col items-center">
            <div class='w-4/5'>
                <div class="grid grid-cols-3 gap-6">
                    <Image src={jon} class="col-span-1 object-contain shadow rounded border-none" />
                    <Image src={jason} class="col-span-1 object-contain shadow rounded border-none" />
                    <Image src={eugene} class="col-span-1 object-contain shadow rounded border-none" />
                </div>
                ...
                <div class="grid grid-cols-3 gap-6">
                    <Image src={yj} class="col-span-1 object-contain shadow rounded border-none" />
                    <Image src={shaune} class="col-span-1 object-contain shadow rounded border-none" />
                </div>
                <div class="grid grid-cols-3 gap-6 justify-items-center">
